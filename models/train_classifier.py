...
def load_data_from_db(database_filepath):
    ...
    # Given value 2 in the related field are neglible so it can be an error. 
    #Replacing 2 with 1.
...
def tokenize(text,url_place_holder_string = "urlplaceholder"):
    ...
    Arguments:
        text : Text messages which will be tokenized
    Output:
        clean_tokens : List of tokens obtained from the input text
    """
